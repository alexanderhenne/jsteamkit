...
public final class SteammessagesGameserversSteamclient {
  ...
  private static final long serialVersionUID = 0L;
    ...
    private static final long serialVersionUID = 0L;
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        result = result && (hasGameport() == other.hasGameport());
        if (hasGameport()) {
          result = result && (getGameport()
              == other.getGameport());
        }
        result = result && (hasSpecport() == other.hasSpecport());
        if (hasSpecport()) {
          result = result && (getSpecport()
              == other.getSpecport());
        }
        ...
        result = result && (hasGamedir() == other.hasGamedir());
        if (hasGamedir()) {
          result = result && getGamedir()
              .equals(other.getGamedir());
        }
        ...
        result = result && (hasBots() == other.hasBots());
        if (hasBots()) {
          result = result && (getBots()
              == other.getBots());
        }
        ...
        result = result && (hasDedicated() == other.hasDedicated());
        if (hasDedicated()) {
          result = result && (getDedicated()
              == other.getDedicated());
        }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      boolean result = true;
      result = result && getServerIpsList()
          .equals(other.getServerIpsList());
      result = result && unknownFields.equals(other.unknownFields);
      return result;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      boolean result = true;
      result = result && getServerSteamidsList()
          .equals(other.getServerSteamidsList());
      result = result && unknownFields.equals(other.unknownFields);
      return result;
    }
